...
⢾⣿⣀⠀⠘⠻⠿⢿⣿⣿⣿⣿⣿⣿⣿⣿⣷⣶⠿⣿⡁
⠈⠙⠛⠿⠿⠿⢿⣿⡿⣿⣿⡿⢿⣿⣿⣿⣷⣄⠀⠘⢷⣆` + colors[0] + "\033[0m\t " + cursor[0] + ` modules` + "\033[32m\033[1m" + `
⠀⠀⠀⠀⠀⢠⣿⠏⠀⣿⡏⠀⣼⣿⠛⢿⣿⣿⣆⠀⠀⣿⡇⡀` + colors[1] + "\033[0m " + cursor[1] + " booty \033[2m(captures)" + "\033[0m\033[32m\033[1m" + `⠀
⠀⠀⠀⠀⢀⣾⡟⠀⠀⣿⣇⠀⢿⣿⡀⠈⣿⡌⠻⠷⠾⠿⣻⠁` + colors[2] + "\033[0m " + cursor[2] + " sos \033[2m(help)" + "\033[0m\033[32m\033[1m" + `⠀
